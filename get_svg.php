...
$collisions = checkmap($type, $width, $height, $tile_size, $kernel_type, $module_type, $data, $colors, true);

$svg_str = get_svg($type, $width, $height, $tile_size, $module_type, $data, $colors, $collisions);
